...
public class FindAccount extends JInternalFrame implements ActionListener {
	...
	FindAccount() {
		...
		super("Search Customer [By No.]", true, true, true, true);
		setSize(350, 235);
	...
	public void actionPerformed(ActionEvent ae) {
		...
		if (obj == btnFind) {
			if (txtNo.getText().equals("")) {
				JOptionPane.showMessageDialog(this, "Please Provide Account ID to Search.",
	...
	void findRec() {
		...
		if (found == false) {
			JOptionPane.showMessageDialog(this, "Account ID " + txtNo.getText() + " Doesn't Exist.",
