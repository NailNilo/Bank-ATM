...
public class ViewOne extends JInternalFrame implements ActionListener {
	...
	ViewOne() {
		...
		super("View Account Holders", true, true, true, true);
		setSize(350, 235);
	...
	public void actionPerformed(ActionEvent ae) {
		...
		if (obj == btnFirst) {
			...
			if (recCount < 0) {
				recCount = 0;
				showRec(recCount);
				JOptionPane.showMessageDialog(this, "You are on First Account holders details.",
						"Bank App - 1st Record", JOptionPane.PLAIN_MESSAGE);
			} else {
				showRec(recCount);
			}
		} else if (obj == btnNext) {
			...
			if (recCount == total) {
				recCount = total - 1;
				showRec(recCount);
				JOptionPane.showMessageDialog(this, "You are on Last Account holders details.",
						"Bank App - End of Records", JOptionPane.PLAIN_MESSAGE);
			} else {
				showRec(recCount);
			}
		} else if (obj == btnLast) {
