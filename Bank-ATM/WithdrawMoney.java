...
public class WithdrawMoney extends JInternalFrame implements ActionListener {
	...
	WithdrawMoney() {
		...
		super("Withdraw Money", true, true, true, true);
		setSize(335, 235);

		jpWith.setLayout(null);

		lbNo = new JLabel("Account ID:");
		lbNo.setForeground(Color.black);
		lbNo.setBounds(15, 20, 80, 25);
		lbName = new JLabel("Customer Name:");
		lbName.setForeground(Color.black);
		lbName.setBounds(15, 55, 80, 25);
		lbDate = new JLabel("Withdraw Date:");
	...
	public void actionPerformed(ActionEvent ae) {
		...
		if (obj == btnSave) {
			if (txtNo.getText().equals("")) {
				JOptionPane.showMessageDialog(this, "Please Provide Account ID.",
						"Bank App - EmptyField", JOptionPane.PLAIN_MESSAGE);
				txtNo.requestFocus();
				...
				if (curr == 0) {
					JOptionPane.showMessageDialog(this, txtName.getText() + "Balance is Empty.",
							"Bank App - Empty Account", JOptionPane.PLAIN_MESSAGE);
					txtClear();
				} else if (withdraw > curr) {
					JOptionPane.showMessageDialog(this, "Withdraw Amount Can't be Greater Than Balance.",
							"Bank App - Large Amount", JOptionPane.PLAIN_MESSAGE);
					txtWithdraw.setText("");
					txtWithdraw.requestFocus();
				} else {
	...
	void findRec() {
		...
		if (found == false) {
			...
			txtClear();
			JOptionPane.showMessageDialog(this, "Account ID " + str + " Doesn't Exist.",
					"Bank App - Wrong ID", JOptionPane.PLAIN_MESSAGE);
		}
		...
		try {
			...
			if (records != null) {
				...
				JOptionPane.showMessageDialog(this, "Account Details Updated Successfully",
						"Bank App - Record Saved", JOptionPane.PLAIN_MESSAGE);
				txtClear();
				dos.close();
				fos.close();
			}
			...
			JOptionPane.showMessageDialog(this, "Error Occurred",
					"Bank App - Error", JOptionPane.PLAIN_MESSAGE);
		}
