...
public class NewAccount extends JInternalFrame implements ActionListener {
	...
	NewAccount() {
		...
		jpInfo.setBounds(500, 500, 500, 500);
	...
	void findRec() {
		...
		for (int x = 0; x < total; x++) {
			if (records[x][0].equals(txtNo.getText())) {
				found = true;
				JOptionPane.showMessageDialog(this, "Account ID " + txtNo.getText() + " Already Exists.",
	...
	void saveFile() {
		...
		try {
			...
			JOptionPane.showMessageDialog(this, "Account Details Have Been Saved Successfully.",
