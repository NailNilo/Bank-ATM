...
public class DeleteCustomer extends JInternalFrame implements ActionListener {
	...
	DeleteCustomer() {
		...
		super("Delete Account Holder", true, true, true, true);
		setSize(350, 235);
	...
	public void actionPerformed(ActionEvent ae) {
		...
		if (obj == btnDel) {
			if (txtNo.getText().equals("")) {
				JOptionPane.showMessageDialog(this, "Please Provide Account ID of Customer.",
	...
	void deletion() {
		...
		try {
			...
			int reply = JOptionPane.showConfirmDialog(this,
					"Are you Sure you want to Delete\n" + txtName.getText() + " Account details From Bank App??",
					"Bank App - Delete", JOptionPane.YES_NO_OPTION, JOptionPane.PLAIN_MESSAGE);
	...
	void deleteFile() {
		...
		try {
			...
			if (records != null) {
				...
				JOptionPane.showMessageDialog(this, "Account details have been Deleted Successfully.",
						"Bank App - Record Deleted", JOptionPane.PLAIN_MESSAGE);
				txtClear();
			} else {
			}
			dos.close();
